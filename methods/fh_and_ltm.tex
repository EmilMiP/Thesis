...
\begin{wrapfigure}{O}{7cm}
	...
	\oldcaption{Illustration of the classical liability threshold model. Liabilities above the threshold $ T $, correspond to a case diagnosis, while liabilities below $ T $ are controls.}
