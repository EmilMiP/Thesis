...
\begin{wrapfigure}{R}{7cm}
	...
	\oldcaption{Illustration of a selected number of Danish registers. They are linked together by the civil registration system. The year denotes the year the register starts.}
...
\textbf{TODO: Following section should be revised}
